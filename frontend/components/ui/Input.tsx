      ...
      <div className="relative group">
        {Icon && (
          <div
            ...
            } text-gray-400 pointer-events-none group-focus-within:text-blue-600 transition-colors`}
          >
            <Icon size={20} />
          </div>
        )}
        <Component
          ...
          className={`
                        ...
                        ${
                          props.readOnly
                            ? "bg-gray-50/50 shadow-none cursor-default"
                            : ""
                        }
                        ${inputClassName}
                    `}
          {...(props as React.InputHTMLAttributes<
            HTMLInputElement | HTMLTextAreaElement
          >)}
        />
      </div>
      {error && (
        <p className="text-[10px] text-red-600 font-black uppercase tracking-wider ml-2">
          {error}
        </p>
      )}
