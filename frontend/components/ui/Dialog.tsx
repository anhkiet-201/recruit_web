...
export default function Dialog({
  ...
  const dialogContent = (
    <div className="fixed inset-0 z-9999 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm transition-opacity animate-in fade-in duration-200">
      <div
        className={`bg-white rounded-4xl shadow-2xl w-full ${maxWidthClass} overflow-hidden transform transition-all scale-100 border border-gray-100 animate-in zoom-in-95 duration-200 relative`}
