            ...
            <div className="h-full bg-white rounded-[2.5rem] p-3 shadow-xl shadow-gray-200/40 border border-gray-100/50 hover:shadow-2xl hover:shadow-blue-200/40 hover:-translate-y-2 transition-all duration-500 flex flex-col relative">
                ...
                <div className="px-5 pt-6 pb-4 flex flex-col flex-1">
                    ...
                    <div className="grid grid-cols-2 gap-y-4 gap-x-2 mb-6">
                        ...
                        <div className="flex items-center gap-2"><div className="p-1.5 bg-blue-50 rounded-xl text-blue-600"><DollarSign size={14} /></div><span className="text-[11px] font-black text-blue-700">{job.salaryMin ? `${job.salaryMin}-${job.salaryMax}` : 'T.Thuận'}</span></div>
                        <div className="flex items-center gap-2"><div className="p-1.5 bg-indigo-50 rounded-xl text-indigo-600"><Briefcase size={14} /></div><span className="text-[11px] font-bold text-indigo-700 uppercase tracking-tight">{job.experienceYears ? `${job.experienceYears} Năm KN` : 'Không KN'}</span></div>
                        <div className="flex items-center gap-2"><div className="p-1.5 bg-orange-50 rounded-xl text-orange-600"><Eye size={14} /></div><span className="text-[11px] font-bold text-orange-700 uppercase tracking-tight">{job.views || 0} Lượt xem</span></div>
                    </div>
