...
export default function FilterSidebar() {
    ...
    // Sync state with URL when searchParams change (important for "Clear" actions)
    useEffect(() => {
        ...
        <div className="space-y-8 sticky top-32">
            <div className="flex items-center justify-between">
                ...
                {searchParams.get("jobType") && (
                    <button onClick={clearFilters} className="text-[10px] font-black text-red-500 uppercase hover:underline">
                        Xóa lọc
                    </button>
                )}
            </div>
            ...
            <div className="bg-blue-600 rounded-[2rem] p-8 text-white relative overflow-hidden group shadow-2xl">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-blue-100 text-xs leading-relaxed mb-6 font-medium">
                        Chúng tôi sẽ gửi những công việc phù hợp nhất vào email của bạn hàng tuần.
                    </p>
                    <input 
                        type="email" 
