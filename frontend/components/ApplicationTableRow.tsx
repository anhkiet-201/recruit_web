    ...
    <Fragment>
      <tr
        ...
        className={`cursor-pointer transition-all duration-300 ${
          isExpanded ? "bg-blue-50/40" : "hover:bg-gray-50/50"
        }`}
      >
        ...
        <td className="px-6 py-6 border-b-none">
          <div className="flex items-center gap-4">
            <div className="h-11 w-11 rounded-2xl bg-linear-to-br from-blue-100 to-indigo-100 flex items-center justify-center text-blue-600 font-black text-lg overflow-hidden border-2 border-white shadow-sm ring-1 ring-gray-100 text-center">
              {app.user?.avatarUrl ? (
                <Image
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-0.5">
                <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">
                  Hồ sơ #ID{app.id.slice(-4).toUpperCase()}
                </span>
              </div>
            </div>
          </div>
        ...
        <td className="px-6 py-6">
          <p className="text-sm font-bold text-gray-700 line-clamp-1 group-hover:text-blue-600">
            {app.job?.title}
          </p>
        </td>
        <td className="px-6 py-6">
        ...
        <td className="px-6 py-6 border-b-none">
          <div onClick={(e) => e.stopPropagation()}>
            <Dropdown
              ...
              onChange={(val) => onStatusChange(val as ApplicationStatus)}
              className="w-full"
            />
          </div>
        </td>
          ...
          {app.cvUrl && (
            ...
            >
              <Button
                ...
                size="sm"
                icon={ExternalLink}
                className="h-9 px-4 rounded-xl text-[10px] font-black uppercase tracking-widest border-gray-200 hover:border-blue-300 hover:text-blue-600 hover:bg-blue-50 transition-all"
              >
                Xem CV
              </Button>
            </a>
      ...
      {isExpanded && (
        <tr className="bg-blue-50/10 transition-all duration-300">
          <td colSpan={6} className="px-12 py-10 border-b border-gray-100/50">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 bg-white rounded-4xl p-8 border border-blue-100/50 shadow-sm relative overflow-hidden">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-4 group">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-black text-gray-800 select-all">
                          {app.user?.email}
                        </p>
                      </div>
                    </div>
              ...
              <div className="md:col-span-2 space-y-6 relative z-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      />
                      <span className="font-black text-sm text-gray-700 group-hover:text-white">
                        Gửi Email trực tiếp
                      </span>
                    </div>
                  ...
                  <a
                    ...
                    className={`flex items-center justify-between p-4 bg-gray-50 rounded-2xl group transition-all border border-transparent ${
                      app.user?.phone
                        ? "hover:bg-emerald-600 hover:shadow-xl hover:shadow-emerald-100"
                ...
                <div className="bg-linear-to-br from-gray-50 to-white border border-gray-100 rounded-3xl p-6 mt-4">
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-indigo-50 rounded-xl flex items-center justify-center text-indigo-600 shrink-0">
                      <Briefcase size={18} />
                    </div>
                    <div>
                      <h5 className="text-xs font-black text-gray-900 mb-1 uppercase tracking-wider">
                        Hợp tác tiếp theo?
                      </h5>
                      <p className="text-xs text-gray-400 leading-relaxed font-medium">
                        Bạn có muốn mời ứng viên này phỏng vấn cho vị trí{" "}
                      ...
                      <div className="flex gap-3 mt-4">
                        <Button
                          size="sm"
                          className="rounded-xl px-5 shadow-lg shadow-blue-100"
                        >
                          Đặt lịch phỏng vấn
                        </Button>
                        <Button
