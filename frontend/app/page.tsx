                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 text-blue-600 text-[10px] font-black uppercase tracking-[0.3em] rounded-2xl mb-8 border border-blue-100">
                            ...
                            Hệ thống tìm việc làm hàng đầu
                        </div>
                        <h1 className="text-5xl sm:text-7xl font-black text-gray-900 tracking-tight mb-8 leading-[1.1]">
                            Cơ hội <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600">nghề nghiệp</span> <br className="hidden sm:block" /> đang chờ đón bạn
                        </h1>
                        <p className="text-xl text-gray-400 font-medium leading-relaxed max-w-2xl mx-auto">
                            Khám phá hàng ngàn công việc từ các công ty uy tín. Chúng tôi kết nối nhân lực với các doanh nghiệp hiệu quả nhất.
                        </p>
                    </div>
                            ...
                            <>
                                <section>
                                    <div className="flex items-center gap-4 mb-12">
                                        ...
                                        <div>
                                            <h2 className="text-3xl font-black text-gray-900 tracking-tight">Việc làm được quan tâm</h2>
                                            <p className="text-[10px] text-gray-400 font-black uppercase tracking-[0.2em] mt-1 ml-0.5">Lượt xem cao nhất tuần</p>
                                        </div>
                                    </div>
                                ...
                                <section>
                                    <div className="flex items-center gap-4 mb-12">
                                        ...
                                        <div>
                                            <h2 className="text-3xl font-black text-gray-900 tracking-tight">Tuyển dụng cực Hot</h2>
                                            <p className="text-[10px] text-gray-400 font-black uppercase tracking-[0.2em] mt-1 ml-0.5">Hồ sơ ứng tuyển nhiều nhất</p>
                                        </div>
                                    </div>
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                                ...
                                <div className="flex items-center gap-4 w-full md:w-auto">
                                    ...
                                    <div>
                                        <h2 className="text-2xl sm:text-3xl font-black text-gray-900 tracking-tight">
                                            {isSearching ? "Kết quả tìm kiếm" : "Việc làm dành cho bạn"}
                                        </h2>
                                        <p className="text-[10px] text-gray-400 font-black uppercase tracking-[0.2em] mt-1 ml-0.5">
                                            {isSearching ? `Tìm thấy ${jobsData.total} vị trí` : "Đề xuất phù hợp nhất"}
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    <div className="p-1 bg-white/60 backdrop-blur-xl rounded-[1.5rem] md:rounded-[2rem] shadow-xl border border-gray-100 flex items-center overflow-x-auto no-scrollbar scroll-smooth">
                                        <div className="flex items-center gap-1 md:gap-2 px-1">
                                            {[
                                                ...
                                                { id: 'unskilled', label: 'Phổ thông', icon: Zap },
                                                { id: 'skilled', label: 'Chất lượng cao', icon: Award },
                                                { id: 'professional', label: 'Có bằng cấp', icon: GraduationCap }
                                            ].map((tab) => {
                                                const Icon = tab.icon;
                                                const isActive = currentJobType === tab.id;
                                                return (
                                                    <Link key={tab.id} href={getFilterUrl(tab.id)} scroll={false}
                                                        className={`flex items-center gap-2 px-6 py-2.5 text-xs font-black uppercase tracking-wider rounded-xl md:rounded-[1.5rem] transition-all whitespace-nowrap ${
                                                            isActive ? "bg-blue-600 text-white shadow-xl" : "text-gray-400 hover:text-gray-900 hover:bg-white/50"
                                                        }`}
                                                    >
                    ...
                    <div className="bg-white/10 backdrop-blur-3xl rounded-[4rem] p-12 md:p-24 border border-white/20 shadow-2xl">
                        <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
                            <div className="text-center lg:text-left">
                                <h2 className="text-5xl md:text-7xl font-black text-white mb-8 tracking-tighter leading-[1]">Bạn là <br/> nhà tuyển dụng?</h2>
                                <p className="text-blue-100 text-xl md:text-2xl mb-12 max-w-xl font-medium leading-relaxed opacity-90">
                                    Tìm kiếm nhân tài phù hợp và xây dựng đội ngũ trong mơ của bạn ngay hôm nay.
                                </p>
