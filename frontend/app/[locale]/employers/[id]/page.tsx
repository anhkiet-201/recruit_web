  ...
  return (
    <div className="min-h-screen bg-gray-50/50 pb-20">
      ...
      <div className="h-64 sm:h-80 relative">
        ...
        <div className="absolute inset-0 bg-linear-to-br from-blue-700 via-blue-600 to-indigo-800 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-end relative z-10">
          <div className="flex flex-col sm:flex-row items-center sm:items-end gap-8 -mb-20 pb-6 w-full">
            <div className="relative group">
              <div className="absolute -inset-1.5 bg-linear-to-tr from-white/50 to-white/20 rounded-[2.5rem] blur opacity-75 group-hover:opacity-100 transition duration-500"></div>
            ...
            <div className="flex-1 text-center sm:text-left pb-4">
              <div className="flex flex-col gap-3">
                <h1 className="text-4xl sm:text-5xl font-black text-white drop-shadow-xl tracking-tight">
                  {employer.name}
                </h1>
                <div className="flex flex-wrap justify-center sm:justify-start items-center gap-3">
                  ...
                  {employer.createdAt && (
                    <div className="bg-gray-900/80 backdrop-blur-md text-white text-[10px] font-black px-4 py-1.5 rounded-full shadow-lg uppercase tracking-widest flex items-center gap-2 border border-white/10">
                      ...
                      {t("memberSince")}{" "}
                      {new Date(employer.createdAt).getFullYear()}
                    </div>
                  )}
                </div>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-32 sm:mt-40">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div className="space-y-6">
                  <div className="group/item flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm font-bold text-gray-700 break-all leading-tight">
                        {employer.email}
                      </p>
                    </div>
                  </div>
          ...
          <div
            id="jobs-section"
            className="lg:col-span-2 space-y-10 scroll-mt-20"
          >
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">
                    {t("totalOfLine")} {jobs.length} {t("listings")}
                  </p>
                </div>
              </div>
            </div>
