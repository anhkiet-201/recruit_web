            ...
            <div className="bg-white rounded-[2.5rem] shadow-2xl shadow-gray-200/50 border border-gray-100 overflow-hidden relative group">
              ...
              <div className="relative h-72 sm:h-[400px] w-full bg-gray-100 overflow-hidden">
                <ImageComponent
                  src={
                    job.imageUrl ||
                    "https://placehold.co/1200x600?text=Job+Cover"
                  }
                  alt={job.title}
                  fill
                  priority={true}
              ...
              <div className="bg-white rounded-[2.5rem] shadow-xl shadow-gray-200/50 border border-gray-100 p-10 relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-4 mb-10">
                    <div className="w-16 h-16 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center border border-blue-100 shadow-sm overflow-hidden shrink-0">
                  ...
                  <button
                    onClick={() =>
                      job.author?.id &&
                      router.push(`/${locale}/employers/${job.author.id}`)
                    }
