...
import { Briefcase, FileText, Users, ChevronRight } from "lucide-react";
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const sortedJobs = [...(jobsData.items || [])]
          .sort(
            (a, b) =>
    ...
    <div className="space-y-10">
      <div>
        ...
        <p className="text-gray-500 font-medium mt-1">
          Chào mừng trở lại! Đây là tóm tắt hoạt động hệ thống.
        </p>
      </div>
            ...
            <table className="min-w-full divide-y divide-gray-100">
              <thead>
                <tr className="bg-gray-50/30 text-[10px] font-black uppercase tracking-widest text-gray-400">
                  <th className="px-8 py-4 text-left">Công việc</th>
                  <th className="px-6 py-4 text-left">Địa điểm</th>
                  <th className="px-6 py-4 text-left">Lương</th>
              ...
              <tbody className="divide-y divide-gray-50">
                {recentJobs.map((job) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-5 text-sm text-blue-600 font-black tracking-tight">
                      {job.salaryMin
