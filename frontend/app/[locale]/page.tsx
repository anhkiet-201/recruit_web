...
export default async function HomePage({
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <header className="relative bg-white pt-20 pb-32 z-30 overflow-hidden">
              ...
              <>
                <section>
                  <div className="flex items-center gap-4 mb-12">
                    <div className="p-4 bg-white rounded-3xl shadow-xl text-blue-600 border border-gray-100">
                      <TrendingUp size={28} />
                    </div>
                    <div>
                ...
                <section>
                  <div className="flex items-center gap-4 mb-12">
                    <div className="p-4 bg-white rounded-3xl shadow-xl text-orange-600 border border-gray-100">
                      <Flame size={28} />
                    </div>
                    <div>
                      <h2 className="text-3xl font-black text-gray-900 tracking-tight">
              ...
              <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-8">
                <div className="flex items-center gap-4 w-full md:w-auto">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-400 font-black uppercase tracking-[0.2em] mt-1 ml-0.5">
                      {isSearching
                        ? t("foundResults", { count: jobsData.total })
                        : t("bestSuggestions")}
                    </p>
                  </div>
                </div>
                      ...
                      {[
                        ...
                        return (
                          <Link
                            ...
                            scroll={false}
                            className={`flex items-center gap-2 px-6 py-2.5 text-xs font-black uppercase tracking-wider rounded-xl md:rounded-3xl transition-all whitespace-nowrap ${
                              isActive
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
              <div className="text-center lg:text-left">
                ...
                <div className="flex flex-wrap gap-6 justify-center lg:justify-start">
                  <Link
                    href="/admin/jobs/new"
                    className="bg-white text-blue-600 font-black px-12 py-5 rounded-[2.5rem] hover:bg-blue-50 transition-all shadow-2xl active:scale-95 text-lg"
                  >
