    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="mb-6">
                ...
                <h1 className="text-3xl font-black text-gray-900 tracking-tight">Đăng tin tuyển dụng mới</h1>
                <p className="text-gray-500 mt-1 font-medium">Hoàn thành form bên dưới để tạo tin tuyển dụng.</p>
            </div>
