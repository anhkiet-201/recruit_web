        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-4 space-y-8">
                    <Card noPadding className="border-none shadow-[0_20px_40px_-5px_rgba(0,0,0,0.1)] relative overflow-visible bg-white">
                        <div className="h-40 bg-gradient-to-br from-blue-700 via-blue-600 to-indigo-600 rounded-t-[2rem] relative overflow-hidden">
                        ...
                        <div className="px-8 pb-10">
                            <div className="relative flex justify-center">
                                <div className="-mt-16 h-36 w-36 bg-white rounded-[2.5rem] p-2 shadow-2xl shadow-blue-900/10 group cursor-pointer overflow-hidden relative border-[6px] border-white transition-transform hover:scale-105 duration-500 z-10">
                                    ...
                                    <div onClick={() => avatarInputRef.current?.click()} className="h-full w-full bg-slate-50 rounded-[2rem] flex items-center justify-center text-blue-600 font-black text-5xl overflow-hidden relative">
                ...
                <div className="lg:col-span-8 space-y-8">
                    ...
                    <Card noPadding className="border-none shadow-[0_20px_40px_-5px_rgba(0,0,0,0.05)] overflow-hidden bg-white">
                        ...
                        <div className="p-8 space-y-10">
                                ...
                                {isEditing ? (
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        {profile?.skills ? profile.skills.split(',').map((s, i) => (
                                            <div key={i} className="px-4 py-2 bg-white border border-slate-200 rounded-xl text-sm font-bold text-slate-700 shadow-sm">
                                                {s.trim()}
                                            </div>
                                        )) : (
                            ...
                            <section className="space-y-6">
                                ...
                                <div className="group relative overflow-hidden rounded-[2rem] bg-gradient-to-r from-slate-50 to-white border border-slate-200 p-1">
                                    <div className="relative flex items-center justify-between p-6 z-10">
                                        <div className="flex items-center gap-5">
                                            <div className="h-14 w-14 bg-white rounded-2xl border border-slate-100 shadow-lg flex items-center justify-center text-red-500">
                                                {cvUploading ? <RefreshCw size={24} className="animate-spin text-blue-600" /> : <FileText size={28} />}
                                            </div>
                                            <div>
                                        ...
                                        <div className="flex gap-3">
                                            ...
                                            {profile?.cvUrl && (
                                                <a href={profile.cvUrl} target="_blank">
                                                    <Button variant="ghost" size="md" icon={ExternalLink} className="bg-white hover:bg-blue-50 text-slate-600 hover:text-blue-600 border border-slate-200 shadow-sm h-10 w-10 !p-0 rounded-xl" />
                                                </a>
                                            )}
                                    ...
                                    {/* Decorator */}
                                    <div className="absolute top-0 right-0 h-full w-1/3 bg-gradient-to-l from-blue-50/50 to-transparent"></div>
                                </div>
                            </section>
                        </div>
                    </Card>
                    ...
                    <section className="space-y-6 pt-6">
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {applications.length > 0 ? applications.slice(0, 3).map((app) => (
                                <Card key={app.id} noPadding className="group hover:-translate-y-1 transition-all duration-300 border-none shadow-[0_4px_20px_-5px_rgba(0,0,0,0.05)] hover:shadow-[0_10px_30px_-5px_rgba(0,0,0,0.1)]">
                                        ...
                                        <div className="flex items-center gap-5">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-3 mt-1 text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                                                    ...
                                                    <span>Ref: <span className="font-mono text-slate-500">{app.id.slice(0, 8)}</span></span>
                                                </div>
                                            </div>
                                        </div>
                                        <Badge variant={app.status === 'accepted' ? 'green' : app.status === 'rejected' ? 'red' : 'yellow'} isDot className="px-4 py-2 text-xs">{app.status}</Badge>
                                    </div>
                                </Card>
                            )) : (
                                <div className="py-16 text-center bg-white rounded-[2rem] border-2 border-dashed border-slate-100 flex flex-col items-center">
